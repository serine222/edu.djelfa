...
<footer class="site-footer">
    <div class="container text-right col-lg-10 col-md-12">
        ...
        <p class="copyright-text f-12 text-center" style="margin-bottom: -18px;">
            <span class="color-white" href="#"><i class="fa fa-circle color-green"></i> المتواجدون الآن &nbsp; <span class="number">7</span></span>
            &nbsp; | &nbsp;
            <span class="color-white" href="#"><i class="fa fa-users"></i> الأعضاء &nbsp; <span class="number">0</span></span>
            &nbsp; | &nbsp;
            <span class="color-white" href="#"><i class="fa fa-eye"></i> الزوار &nbsp; <span class="number">7</span></span>
        </p>
        <hr class="mt-4">
