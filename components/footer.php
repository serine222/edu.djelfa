...
<footer class="site-footer">
  <div class="container text-right col-lg-10 col-md-12">
      ...
      <p class="copyright-text f-12 text-center" style="margin-bottom: -18px;">
          <span class="color-white" href="#"><i class="fa fa-circle color-green"></i> المتواجدون الآن &nbsp; <span class="number">2</span></span>
          &nbsp; | &nbsp;
          <span class="color-white" href="#"><i class="fa fa-users"></i> الأعضاء &nbsp; <span class="number">0</span></span>
          &nbsp; | &nbsp;
          <span class="color-white" href="#"><i class="fa fa-eye"></i> الزوار &nbsp; <span class="number">2</span></span>
      </p>
      <hr class="mt-4">
      ...
      <div class="row">
          <div class="col-md-12 col-sm-12 col-xs-12">
              <div class="btn-group" role="group" aria-label="Basic example"> 
                  <button class="btn btn-green btn-sm Hoverable" >الجلفة إنفو</button>
                  <button class="btn btn-green btn-sm Hoverable" >سياسة الخصوصية</button>
                  <button class="btn btn-green btn-sm Hoverable" >قوانين المنصة</button>
                  <button class="btn btn-green btn-sm Hoverable" onclick="window.location.href = '';">إتصل بنا</button>
              </div> 
              <p class="copyright-text f-14 mt-2"> جميع الحقوق محفوظة © <span class="number"> 2023                    </span>
